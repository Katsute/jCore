...
public final class SampleTests {
    ...
    public void testJUnit(){
        Assumptions.assumeTrue(System.getenv("sample-only") != null && System.getenv("sample-only").equals("false"));
    ...
    public void testJCore(){
        Assumptions.assumeTrue(System.getenv("sample-only") != null && System.getenv("sample-only").equals("true"));
